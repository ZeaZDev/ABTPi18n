...
class FeatureExtractor:
    ...
    def extract_signal_features(self, signal: Dict[str, Any], market_data: Dict[str, Any] = None) -> Dict[str, float]:
        """
        ...
        if market_data:
            ...
            features['market_volume_ratio'] = float(market_data.get('volume_ratio', 1.0))
        ...
        features['bollinger_position'] = float(indicators.get('bollinger_position', 0.5))
        ...
        features['take_profit_distance'] = float(signal.get('take_profit_distance', 0.04))
