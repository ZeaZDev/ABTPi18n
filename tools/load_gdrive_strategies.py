...
from src.services.gdrive_loader import GoogleDriveLoader, load_tradingview_strategies_from_gdrive
...
def main():
    ...
    try:
        ...
        # Download folder
        folder_path = loader.download_folder(args.url, args.output, quiet=not args.verbose)
        ...
        print("\n" + "=" * 60)
        print(f"✓ Successfully loaded {len(configs)} strategies from Google Drive")
