...
class CircuitBreaker:
    ...
    def record_trade_outcome(self, is_profitable: bool, timestamp: Optional[datetime] = None):
    ...
    def trip_breaker(self):
        ...
        self.tripped_until = datetime.utcnow() + timedelta(minutes=self.cooldown_minutes)
    ...
    def get_status(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "trades_last_hour": len([t for t in self.recent_trades 
