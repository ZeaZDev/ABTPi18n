...
class SignalQualityScorer:
    ...
    def train(self, historical_signals: List[Dict], outcomes: List[str]) -> Dict[str, float]:
        """
        ...
        features = [extractor.extract_signal_features(sig) for sig in historical_signals]
        ...
        return {
            'accuracy': accuracy,
            'samples': len(historical_signals)
        }
    
    def score_signal(self, signal: Dict[str, Any], market_data: Dict[str, Any] = None) -> Dict[str, Any]:
        """
